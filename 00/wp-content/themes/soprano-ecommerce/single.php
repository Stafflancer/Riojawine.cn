								...
								<div class = "container_links">
									...
									<div class = "container_social_buttons">
                                        ...
                                        <a href="javascript: void(0);" data-layout="button"
                                           onclick="window.open('http://service.weibo.com/share/share.php?url=<?php the_permalink(); ?>&appkey=&title=<?php the_title(); ?>&pic=&ralateUid=','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');">
