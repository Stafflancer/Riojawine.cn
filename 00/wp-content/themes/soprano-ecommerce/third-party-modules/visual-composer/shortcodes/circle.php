...
class SopranoTheme_VC_Circle extends SopranoTheme_VC_ShortcodeBase {
	...
	public function shortcode_render( $atts, $content = null ) {
		...
		return $this->render_template( 'circle', $atts );
	}
	...
	public function vc_map_shortcode() {
		...
		$sc_params = array(
			...
			array(
				...
				'value'      => '0.85',
				'admin_label' => true,
				'description' => esc_html__( 'From 0.1 to 1.', 'soprano-ecommerce' )
			),
		...
		vc_map( array(
			'name'     => esc_html__( 'Animated Circle', 'soprano-ecommerce' ),
...
return new SopranoTheme_VC_Circle();