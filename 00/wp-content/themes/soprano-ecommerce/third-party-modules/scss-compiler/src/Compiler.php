...
class Compiler
{
    ...
    public function compile($code, $path = null)
    {
        ...
        $this->stderr         = $fopne_func('php://stderr', 'w');
    ...
    protected function compileChild($child, OutputBlock $out)
    {
        ...
        switch ($child[0]) {
            ...
            case Type::T_DEBUG:
	            ...
	            $fwrite_func($this->stderr, "Line $line DEBUG: $value\n");
                break;
            ...
            case Type::T_WARN:
                ...
                $line = $this->sourceLine;
                $value = $this->compileValue($this->reduce($value, true));
	            $fwrite_func($this->stderr, "Line $line WARN: $value\n");
                break;
